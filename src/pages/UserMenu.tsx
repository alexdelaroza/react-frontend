...
const UserMenu: React.FC = () => {
    ...
    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        if (searchId.trim()) {
            navigate(`/usuarios/editar/${searchId}`);
        }
    };

    return (
        <div className="container mt-5" style={{ maxWidth: '600px' }}>
            <h2 className="mb-4 text-center">Gestão de Usuários</h2>
                    ...
                    <div className="card shadow-sm border-dark">
                        <div className="card-body">
                            ...
                            <p className="card-text text-muted small">
                                Visualize todos os usuários ou busque um específico por código.
                            </p>
                ...
                <div className="col-12">
                    <div className="card shadow-sm border-dark">
                        <div className="card-body">
                            ...
                            <p className="card-text text-muted small">
                                Cadastre novos perfis ou gerencie permissões do sistema.
                            </p>
                            ...
                            <div className="alert alert-light border-0 mb-0 py-1 text-center">
                                <p className="small text-secondary mb-0">
                                    * Para <strong>Alterar</strong> ou <strong>Deletar</strong>, 
                                    utilize a lista geral ou a consulta por ID acima.
                                </p>
                            </div>
                        </div>
                    </div>
